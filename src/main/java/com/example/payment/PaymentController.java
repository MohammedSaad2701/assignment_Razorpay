...
public class PaymentController {
    ...
    private static final String KEY_ID = "rzp_test_S65IPBWLddy1iu"; // Replace with your Key ID
    private static final String KEY_SECRET = "VyLZuDI4aalCdinVv9e1Ot8u"; // Replace with your Key Secret
